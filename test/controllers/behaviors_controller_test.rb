...
class BehaviorsControllerTest < ActionController::TestCase
  ...
  test "should create behavior" do
    assert_difference 'Behavior.count' do
      post :create, behavior: { icon_url: @behavior.icon_url, name: @behavior.name, icon_type: @behavior.icon_type }
    end
  ...
  test "should update behavior" do
    patch :update, id: @behavior, behavior: { icon_url: @behavior.icon_url, name: @behavior.name, icon_type: @behavior.icon_type }
    assert_redirected_to behavior_path(assigns(:behavior))
  end
