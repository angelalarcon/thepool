class BehaviorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @behavior.save
        format.html { redirect_to @behavior, notice: 'Comportamiento creado de manera exitosa.' }
  ...
  def update
    respond_to do |format|
      if @behavior.update(behavior_params)
        format.html { redirect_to @behavior, notice: 'Comportamiento actualizado de manera exitosa.' }
  ...
  private
    ...
    def behavior_params
      params.require(:behavior).permit(:name, :icon_url, :icon_code, :icon_type)
    end
end
